...
import io.github.jr1811.ashbornrp.client.feature.model.DryadCloakModel;
...
public class DryadCloakRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final DryadCloakModel<T> model;
    private final Accessory accessory;


    public DryadCloakRenderer(FeatureRendererContext<T, M> context, Accessory accessory, EntityModelLoader loader) {
        super(context);
        this.model = new DryadCloakModel<>(loader.getModelPart(AshbornModEntityModelLayers.CLOAK_DRYAD));
        this.accessory = accessory;
    }

    @Override
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/cloak_dryad.png");
    }
