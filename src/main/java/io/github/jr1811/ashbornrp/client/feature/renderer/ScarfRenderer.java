...
public class ScarfRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final ScarfModel<T> model;
    private final Accessory accessory;


    public ScarfRenderer(FeatureRendererContext<T, M> context, Accessory accessory, EntityModelLoader loader) {
        super(context);
        this.model = new ScarfModel<>(loader.getModelPart(AshbornModEntityModelLayers.SCARF));
        this.accessory = accessory;
    }

    @Override
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/scarf.png");
    }
