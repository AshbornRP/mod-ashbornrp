...
import io.github.jr1811.ashbornrp.client.feature.model.FlatTailModel;
...
public class FlatTailRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final FlatTailModel<T> model;
    private final Accessory accessory;
    private final String texture;

    public FlatTailRenderer(FeatureRendererContext<T, M> context, Accessory accessory, EntityModelLoader loader, String texture) {
        super(context);
        this.model = new FlatTailModel<>(loader.getModelPart(AshbornModEntityModelLayers.TAIL_FLAT), accessory);
