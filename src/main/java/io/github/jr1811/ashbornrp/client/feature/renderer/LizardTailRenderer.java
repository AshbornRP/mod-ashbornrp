...
public class LizardTailRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final LizardTailModel<T> model;
    ...
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/lizard_tail.png");
    }
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, T entity, float limbAngle,
        ...
        matrices.translate(translation.x, translation.y + 0.22, translation.z + 0.52);
