...
public class GenericAccessoryRenderer<
        T extends PlayerEntity,
        M extends PlayerEntityModel<T>,
        S extends SinglePartEntityModel<T>
    ...
    public GenericAccessoryRenderer(FeatureRendererContext<T, M> context, Accessory accessory, S model, String texture) {
        super(context);
        this.model = model;
    ...
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId(texture);
    }
