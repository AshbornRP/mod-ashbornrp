...
public class PeltWolfRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final PeltWolfModel<T> model;
    private final Accessory accessory;


    public PeltWolfRenderer(FeatureRendererContext<T, M> context, Accessory accessory, EntityModelLoader loader) {
        super(context);
        this.model = new PeltWolfModel<>(loader.getModelPart(AshbornModEntityModelLayers.PELT_WOLF));
        this.accessory = accessory;
    }

    @Override
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/pelt_wolf.png");
    }
