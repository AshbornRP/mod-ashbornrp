...
public class RoundTailRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final RoundTailModel<T> model;
    ...
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/tail_round.png");
    }
