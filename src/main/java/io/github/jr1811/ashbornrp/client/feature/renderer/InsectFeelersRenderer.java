...
public class InsectFeelersRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final InsectFeelersModel<T> model;
    ...
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/feelers_insect.png");
    }
