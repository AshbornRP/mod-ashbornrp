...
public class SpiderBodyRenderer<T extends LivingEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final SpiderBodyModel model;
    ...
    protected Identifier getTexture(T entity) {
        return AshbornMod.getId("textures/entity/spider_body.png");
    }
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, T entity, float limbAngle,
        ...
        this.model.setAngles(player, limbAngle, limbDistance, animationProgress, headYaw, headPitch);
