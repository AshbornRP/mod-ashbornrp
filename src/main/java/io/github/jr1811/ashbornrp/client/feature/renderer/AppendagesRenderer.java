...
public class AppendagesRenderer<T extends PlayerEntity, M extends PlayerEntityModel<T>> extends FeatureRenderer<T, M> {
    private final AppendagesModel<T> model;
    private final Accessory accessory;
    private final String texture;

    public AppendagesRenderer(FeatureRendererContext<T, M> context, Accessory accessory, EntityModelLoader loader, String texture) {
        super(context);
        this.model = new AppendagesModel<>(loader.getModelPart(AshbornModEntityModelLayers.APPENDAGES), accessory);
