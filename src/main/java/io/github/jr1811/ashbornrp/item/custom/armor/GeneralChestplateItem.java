...
public class GeneralChestplateItem extends ArmorItem implements IAnimatable {
    public final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public GeneralChestplateItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
