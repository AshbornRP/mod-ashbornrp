...
public class GeneralHeadItem extends ArmorItem implements IAnimatable {
    public final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public GeneralHeadItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
