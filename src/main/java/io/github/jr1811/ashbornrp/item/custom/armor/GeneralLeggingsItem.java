...
public class GeneralLeggingsItem extends ArmorItem implements IAnimatable {
    public final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public GeneralLeggingsItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
