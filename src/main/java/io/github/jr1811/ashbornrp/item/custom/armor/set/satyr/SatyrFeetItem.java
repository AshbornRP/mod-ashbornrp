...
public class SatyrFeetItem extends GeneralBootsItem implements IAnimatable {
    public final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public SatyrFeetItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
