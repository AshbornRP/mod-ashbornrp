...
public class LamiaTailModel extends AnimatedGeoModel<LamiaTailArmorSetItem> {
    ...
    public Identifier getModelLocation(LamiaTailArmorSetItem object) {
        return new Identifier(AshbornMod.MOD_ID, "geo/lamia.geo.json");
    }

    @Override
    public Identifier getTextureLocation(LamiaTailArmorSetItem object) {
        if (object.getName().toString().contains("dark")) {
            return new Identifier(AshbornMod.MOD_ID, "textures/models/armor/lamia_dark.png");
        }
        if (object.getName().toString().contains("boa")) {
            return new Identifier(AshbornMod.MOD_ID, "textures/models/armor/lamia_boa.png");
        }
        return new Identifier(AshbornMod.MOD_ID, "textures/models/armor/lamia.png");
    }

    @Override
    public Identifier getAnimationFileLocation(LamiaTailArmorSetItem animatable) {
        return new Identifier(AshbornMod.MOD_ID, "animations/lamia.animation.json");
    }
}
