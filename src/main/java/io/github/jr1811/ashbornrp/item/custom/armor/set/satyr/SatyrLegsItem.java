...
public class SatyrLegsItem extends GeneralLeggingsItem implements IAnimatable {
    public final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public SatyrLegsItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
