...
public class AntlersMooseModel extends AnimatedGeoModel<GenericArmorSetItem> {
    @Override
    public Identifier getModelLocation(GenericArmorSetItem object) {
        return new Identifier(AshbornMod.MOD_ID, "geo/antlers_moose.geo.json");
    }

    @Override
    public Identifier getTextureLocation(GenericArmorSetItem object) {
        return new Identifier(AshbornMod.MOD_ID, "textures/models/armor/antlers_moose.png");
    }
